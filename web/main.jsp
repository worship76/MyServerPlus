...
<div region="north" style="height: 60px;background-color: #ffff">
    <table width="100%">
        <tr>
            <td width="50%"></td>
            <div style="width: 120px;height: 20px; float: left; font-size: 20px; font-weight: bold; line-height: 20px; padding-left: 20px">
                火灾安防系统
            </div>
            <td valign="bottom"
    ...
    <div class="easyui-tabs" fit="true" border="false" id="tabs">
        <div title="首页" data-options="iconCls:'icon-home'">
            <div align="center" style="padding-top: 100px">
                <font color="grey" size="10">欢迎使用本系统</font>
            </div>
        </div>
    </div>
</div>
<div region="west" style="width: 200px;height:500px;" title="导航菜单"
    ...
    <div class="easyui-accordion">
        ...
        <div title="系统信息" data-options="iconCls:'icon-shujias'"
             style="padding:10px">
            <a href="javascript:openTab(' 传感器(表)','sensorData.jsp','icon-shujia')"
               class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-shujia'"
               style="width: 150px;"> 传感器(表)</a>
            <%--<a href="javascript:openTab(' 传感器(图)','sensorPhoto.jsp','icon-shujia')"
               class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-shujia'"
               style="width: 150px;"> 传感器(图)</a>--%>
            <a href="javascript:openTab(' 用户信息','userManage.jsp','icon-student')"
               class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-student'"
               style="width: 150px;"> 用户信息</a>
        </div>
...
<div region="south" style="width: 200px;height:25px;">
    <div style="height: 20px; line-height: 20px; text-align: center; color: gray">
        Copyright &copy; 1607094120李彬
    </div>
</div>
